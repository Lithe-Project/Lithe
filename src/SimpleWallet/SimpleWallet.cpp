...
bool simple_wallet::init(const boost::program_options::variables_map& vm) {
  ...
  if (!m_generate_new.empty()) {
    ...
    if (key_import) {
      ...
      /* This is not used, but is needed to be passed to the function, 
...
/* This function shows the number of outputs in the wallet that are below the dust threshold */
...
//--- Misc.
/* shows the basic wallet commands menu aka "help" */
...
/* shows the advanced wallet commands menu */
