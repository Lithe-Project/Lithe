...
const size_t   CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW = 15; /* 20 minutes */
...
const uint64_t MINIMUM_FEE = UINT64_C(10); /* 0.00010 CCX */
const uint64_t MINIMUM_FEE_V1 = UINT64_C(100); /* 0.00100 CCX */
const uint64_t MINIMUM_FEE_V2 = UINT64_C(1000); /* 0.01000 CCX */
const uint64_t MINIMUM_FEE_BANKING = UINT64_C(1000); /* 0.01000 CCX */
const uint64_t DEFAULT_DUST_THRESHOLD = UINT64_C(10); /* 0.00010 CCX */  
